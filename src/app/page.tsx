          ...
          <div className={styles.heroGrid}>
            ...
            <div className={styles.heroVisual}>
              <div className={styles.heroVisualMain}>
                <Image
                  src="/products/non-woven-bag.jpg"
                  alt="Non Woven Bag"
                  width={640}
                  height={640}
              ...
              <div className={styles.heroVisualStack}>
                <div className={styles.heroVisualThumb}>
                  <Image src="/products/canvas-tarpaulin.jpg" alt="Canvas Tarpaulin" width={300} height={300} className={styles.heroVisualImage} />
                </div>
                <div className={styles.heroVisualThumb}>
                  <Image src="/products/non-woven-fabric-roll.jpg" alt="Non Woven Roll" width={300} height={300} className={styles.heroVisualImage} />
                </div>
              </div>
            </div>
          </div>
